...
/**
 * @description Directive `v-ripple`
 * @use Usage as follows:
 * 1. `v-ripple` represents enabling the basic ripple effect.
 * 2. `v-ripple="{ class: 'text-red' }"` represents customizing the ripple color, supports tailwindcss, and the effective style is `color`.
 * 3. `v-ripple.center` represents that the ripple effect starts from the center and spreads outwards.
 */
