/**
 * @description ⚠️：This file is only for theme plugins, please do not export other utility functions in this file (only run before the page loads)
 */
...
/**
 * @description Process the preset accent color into the format required by the theme plugin
 */
