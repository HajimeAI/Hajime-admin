...
export function useDataThemeChange() {
  ...
  /** Set the navigation accent color */
  function setLayoutThemeColor(
    ...
    // If it is not isClick, keep the previous themeColor
  ...
  /** Set the 'element-plus' accent color */
  ...
  /** The overall style of light and dark colors is switched */
