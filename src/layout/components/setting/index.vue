...
<template>
  <panel>
    <div class="p-6">
      <p class="mb-3 font-medium text-sm dark:text-white">Whole Style</p>
      <Segmented
        class="select-none"
      ...
      <p class="mt-5 mb-3 font-medium text-sm dark:text-white">Theme Color</p>
      ...
      <p class="mt-5 mb-3 font-medium text-sm dark:text-white">Nav Patterrn</p>
      <ul class="pure-theme">
        <li
          ref="verticalRef"
          v-tippy="{
      ...
      <p class="mt-5 mb-3 font-medium text-base dark:text-white">Tab Style</p>
      <Segmented
        class="select-none"
      ...
      <p class="mt-5 mb-1 font-medium text-sm dark:text-white">Show</p>
      <ul class="setting">
        <li>
          <span class="dark:text-white">Gray Partten</span>
          <el-switch
        ...
        <li>
          <span class="dark:text-white">Color Blindness Mode</span>
          <el-switch
